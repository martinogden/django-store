...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('basket_basket', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='baskets', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('basket', ['Item'])
