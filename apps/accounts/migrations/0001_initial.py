...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_address', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='address', unique=True, blank=True, to=orm['auth.User'])),
        ...
        db.create_table('accounts_order', (
            ...
            ('basket', self.gf('django.db.models.fields.related.OneToOneField')(related_name='order', unique=True, to=orm['basket.Basket'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=25)),
        ))
