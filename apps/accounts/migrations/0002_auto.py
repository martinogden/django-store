...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_order_items', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm['accounts.order'], null=False)),
            ('item', models.ForeignKey(orm['basket.item'], null=False))
        ))
        db.create_unique('accounts_order_items', ['order_id', 'item_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field items on 'Order'
        db.delete_table('accounts_order_items')
